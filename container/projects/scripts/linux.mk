...
LINUX_IMG_PATH = $(KERNEL_PATH)/arch/$(ARCH)/boot/zImage
...
all:
	$(HIDE)$(MAKE) -C $(KERNEL_PATH) ARCH=$(ARCH) CROSS_COMPILE=$(CROSS_COMPILE)
	$(HIDE)strings $(KERNEL_PATH)/vmlinux | grep -m1 "Linux version" | awk '{print $$3}' > $(KVERSION_FILE)
...
clean:
	$(HIDE)$(MAKE) -C $(KERNEL_PATH) ARCH=$(ARCH) CROSS_COMPILE=$(CROSS_COMPILE) clean
